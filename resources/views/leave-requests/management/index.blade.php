        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                    {{ __('leave-requests.manage') }}
                </h2>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    {{ __('leave-requests.manage_subtitle') }}
                </p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-management.header-card
                :title="__('leave-requests.pending_title')"
                :subtitle="__('leave-requests.pending_subtitle', ['pending' => $pendingCount])"
                :action-href="route('leave-requests.management.history')"
                :action-label="__('leave-requests.view_history')"
            >
                <x-slot:icon>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-end items-center mb-4 space-x-4">
                        <form method="GET" action="{{ route('leave-requests.management.index') }}"
                                    ...
                                    <td colspan="8" class="px-6 py-16">
                                        <div class="text-center">
                                            ...
                                            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                                {{ __('leave-requests.no_leave_requests') }}
                                            </p>
                                        </div>
                                    </td>
                                </tr>
